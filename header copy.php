...
<body class='home'>
    ...
    .menu__overlay {
        background-image: linear-gradient(rgba(0, 0, 0, 0.7),
                rgba(0, 0, 0, 0.7)), url(<?php getMyImage(get_field('main_menu_background_image'), 'large');
        ?>);
    }

    #back-image-very-small {
        background-image: url(<?php getMyImage(get_field('main_background_image'), "medium");
        ?>);
    }

    .popupHeaderIcon {
        background-image: url(<?php getMyImage(get_field('banner_image'), "medium");
        ?>);
    }
    </style>
    ...
    <img id='backImageMem' style="display:none">

    <section id='back-image-very-small'></section>
    <section id='main_background_slide_1' class='main_background_slide'></section>
    <section id='main_background_slide_2' class='main_background_slide'></section>
    <section id='main_background_slide_3' class='main_background_slide'></section>
    <section id='main_background_slide_0' class='main_background_slide'></section>
    ...
    <header id="banner" class="banner">
        ...
        <div id="popupHeader" class=" popupHeader">
            <div class="row  h-100 PopRow">
                <div class="col-4 col-lg-6 d-none d-md-flex leftPopCol">
                    <div class="popupHeaderIcon">
                    </div>

                </div>
                <div class="col rightPopCol">
                    <?php
                    wp_nav_menu(
                        array(
        ...
        <div class="shapeContainer">
            <div class="shape">
                <div class="image-holder"><img class="main-icon-image"
                        src="<?php getMyImage(get_field('logo_image'), "medium"); ?>"></div>
                <span class="para-holder"><?php the_field('intro_paragraph'); ?></span>
            </div>
        </div>
